...
use purrcrypt::cipher::efficient::{EfficientPetCipher, EmotionalContext, FileType, PetDialect};
...
fn bench_dialect_comparison(c: &mut Criterion) {
    ...
    for dialect in &dialects {
        for context in &contexts {
            let cipher =
                EfficientPetCipher::new_with_context(*dialect, FileType::Unknown, *context);
